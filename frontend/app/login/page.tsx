          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            ...
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-[hsl(var(--outline-variant))]" />
              </div>
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[hsl(var(--surface))] text-[hsl(var(--on-surface-variant))]">Or continue with</span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-full border border-[hsl(var(--outline))] hover:bg-[hsl(var(--surface-container))] transition-colors font-medium"
              >
