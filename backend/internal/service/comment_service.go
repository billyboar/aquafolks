...
func (s *CommentService) CreateComment(ctx context.Context, userID, commentableType, commentableID, content string, imageURLs []string) (*domain.Comment, error) {
	...
	return s.commentRepo.Create(ctx, userID, commentableType, commentableID, content, imageURLs)
}
